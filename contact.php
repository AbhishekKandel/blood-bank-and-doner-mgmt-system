...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
                ...
                <form name="sentMessage" method="post">
                    ...
                    <div class="control-group form-group">
                        <div class="controls">
                            ...
                            <input type="email" class="form-control" id="email" name="email" required data-validation-required-message="Please enter your email Zone.">
                        </div>
                    </div>
                    <div class="control-group form-group">
                        <div class="controls">
            ...
            <?php
            $pagetype = $_GET['type'];
            $sql = "SELECT Zone,EmailId,ContactNo from tblcontactusinfo";
            $query = $dbh->prepare($sql);
    ...
    <!-- Do not edit these files! In order to set the email Zone and subject line for the contact form go to the bin/contact_me.php file. -->
